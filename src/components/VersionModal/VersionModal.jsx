  ...
  return (
    <>
      ...
      >
        <div className={`vm-card ${horariosOpen ? 'vm-card--dimmed' : ''}`} onClick={(e) => e.stopPropagation()}>
          ...
          <div className="vm-header">
            ...
            <button className="vm-header__close" onClick={onClose} type="button" aria-label="Cerrar">
      ...
      {confirmDelete && (
        <ConfirmModal
          icon="🗑️"
          message="¿Estás seguro de que querés eliminar esta versión? Esta acción no se puede deshacer."
