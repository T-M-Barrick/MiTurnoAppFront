      ...
      <div className="ps-strip-month-row">
        <div className="ps-strip-header__month">
          ...
          {monthPickerOpen && (() => {
            ...
            return (
              <div className={`ps-month-picker${pickerUp ? ' ps-month-picker--up' : ''}`} onClick={e => e.stopPropagation()}>
                {/* Navegación de año */}
            ...
            <div className="ps-sucursal-info">
              ...
              {dirTexto && (
                <p className="ps-sucursal-row">
                  ...
                  <span className="ps-dir-group">
                    <span className="ps-dir-text">{dirTexto}</span>
                    {mapsUrl && (
